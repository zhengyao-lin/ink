...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_ASSIGNING_UNASSIGNABLE_EXPRESSION,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_HASH_NOT_FOUND,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_GET_SLOT_OF_UNDEFINED,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_INSERT_NON_FUNCTION_OBJECT,
					 ...
					 Ink_ArrayValue::size_type size)
{
	...
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_INDEX_EXCEED,
							 strm.str().c_str());
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_BONDING_FAILED,
							 "Failed to bond");
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_SELF_BONDING,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_GET_NON_ARRAY_INDEX,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FUNCTION_RANGE_CALL_ARGUMENT_ERROR,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FUNCTION_NON_RANGE_CALL,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_INCORRECT_RANGE_TYPE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_GET_NON_FUNCTION_EXP,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_REBUILD_NON_ARRAY,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_INVALID_ELEMENT_FOR_REBUILD,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_REMOVE_ARGUMENT_REQUIRE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_TOO_HUGE_INDEX,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_EACH_ARGUMENT_REQUIRE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_FINDING_METHOD,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_WRONG_TYPE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_WRONG_BASE_TYPE,
...
InkWarn_Too_Less_Argument(Ink_InterpreteEngine *engine, Ink_ArgcType min, Ink_ArgcType argc)
{
	...
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_TOO_LESS_ARGUMENT,
							 strm.str().c_str());
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_WRONG_ARGUMENT_TYPE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_NOT_PACKAGE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_SETTING_UNASSIGNABLE_GETTER,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_SETTING_UNASSIGNABLE_SETTER,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_TYPE_NAME_ARGUMENT_REQUIRE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_WITH_ATTACHMENT_REQUIRE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_OPEN_FILE,
							 "Failed to open file $(path)", path);
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_FIND_MOD,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_LOAD_MOD,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_FIND_LOADER,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_FIND_INIT,
...
InkWarn_Failed_Init_Mod(Ink_InterpreteEngine *engine, int errnum)
{
	...
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_INIT_MOD,
							 strm.str().c_str());
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_HASH_TABLE_MAPPING_EXPECT_STRING,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_DELETE_FUNCTION_ARGUMENT_REQUIRE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_EVAL_CALLED_WITHOUT_CURRENT_ENGINE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_INVALID_ARGUMENT_FOR_STRING_ADD,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_INVALID_RETURN_VALUE_OF_TO_STRING,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_LOAD_MOD_ON_WRONG_OS,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_NO_FILE_IN_MOD,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_ACTOR_CONFLICT,
...
InkWarn_Failed_Create_Process(Ink_InterpreteEngine *engine, int err_code)
{
	...
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_CREATE_PROCESS,
							 strm.str().c_str());
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_CIRCULAR_PROTOTYPE_REFERENCE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_STRING_INDEX_EXCEED,
							 "String index exceed length of the string");
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_SUB_STRING_EXCEED,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_UNREACHABLE_BONDING,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_DIVIDED_BY_ZERO,
							 "Divided by zero");
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_UNDEFINED_CUSTOM_INTERRUPT_NAME,
...
InkWarn_Unregistered_Interrupt_Signal(Ink_InterpreteEngine *engine, Ink_InterruptSignal sig)
{
	...
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_UNREGISTERED_INTERRUPT_SIGNAL,
							 strm.str().c_str());
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_TRAPPING_UNTRAPPED_SIGNAL,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_PACKAGE_BROKEN,
...
InkWarn_Failed_Create_Coroutine(Ink_InterpreteEngine *engine, int err_code)
{
	...
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_CREATE_COROUTINE,
							 strm.str().c_str());
	return;
}
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_COCALL_ARGUMENT_REQUIRE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_WRONG_RET_VAL_FOR_COMPARE,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_ASSIGN_FIXED,
...
{
	InkErro_doPrintWarning_e(engine, INK_EXCODE_WARN_FAILED_GET_CONSTANT,
